<div class="switch-change-cont">
	...
	<div class="switch-imperial-cont clearfix formimperial form-switch" id="imperial-switch">
		<form  method="POST" action="bfb_calculator" class="form-horizontal clearfix" id="calformImp">
				...
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input placeholder="<?php echo __('Years','health');?>" class="c_input" required="required" max="95" min="18" name="age" type="number">
				</div-->
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				...
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input placeholder="<?php echo __('Inches','health');?>" min="10" max="96" name="abd1" required="required" class="c_input" min="15" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Waist size at your naval:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input class="c_input" required="required" min="15" name="abd2" placeholder="<?php echo __('Inches','health');?>" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Hip size at widest point:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input required="required" class="c_input" min="15" name="hip" placeholder="<?php echo __('Inches','health');?>" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Thigh size at widest point:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input class="c_input" required="required" min="15" placeholder="<?php echo __('Inches','health');?>" name="thigh" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Neck at narrowest point:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input name="neck" min="4" max="36" placeholder="<?php echo __('Inches','health');?>" required="required" class="c_input" min="8" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Biceps at widest point:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input min="5" class="c_input" required="required" placeholder="<?php echo __('Inches','health');?>" name="biceps" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Forearm at widest point:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input min="4" required="required" class="c_input" placeholder="<?php echo __('Inches','health');?>" name="forearm" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Wrist at narrowest point:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input required="required" class="c_input" min="4" placeholder="<?php echo __('Inches','health');?>" name="wrist" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Enter your weight:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input required="required" min="50" max="950" class="c_input" max="695" min="65" placeholder="<?php echo __('Pounds','health');?>" name="weight" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				...
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					...
					<input type="hidden" name="action" value="bfb_calculator" />
				</div>
	...
	<div class="switch-metric-cont hide clearfix formmetric form-switch" id="metric-switch">
		<form  method="POST" action="bfb_calculator" class="form-horizontal   clearfix" id="calformMetric">
			<div class="calc_quest"></div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Enter your gender:','health');?>
			</div>
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="15" min="25" max="244" required="required" class="c_input" placeholder="<?php echo __('cm','health');?>" name="abd1" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Waist size at your naval:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="15" required="required" class="c_input" name="abd2" placeholder="<?php echo __('cm','health');?>" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Hip size at widest point:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="15" required="required" class="c_input" placeholder="<?php echo __('cm','health');?>" name="hip" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Thigh size at widest point:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="15" required="required" class="c_input" name="thigh" placeholder="<?php echo __('cm','health');?>" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Neck at narrowest point:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="10" max="91" placeholder="<?php echo __('cm','health');?>" name="neck"  class="c_input" required="required" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Biceps at widest point:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input class="c_input" required="required" min="12" placeholder="<?php echo __('cm','health');?>" name="biceps" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Forearm at widest point:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input placeholder="<?php echo __('cm','health');?>" name="forearm" required="required" class="c_input" min="11" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Wrist at narrowest point:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input name="wrist" placeholder="<?php echo __('cm','health');?>" class="c_input" required="required" min="7" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Enter your weight:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="22" max="430" placeholder="<?php echo __('kilos','health');?>" required="required" class="c_input" max="385" min="30" name="weight" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Select your height:','health');?>
			</div>
