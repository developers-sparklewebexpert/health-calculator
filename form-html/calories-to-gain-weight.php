<div class="switch-change-cont">
	...
	<div class="switch-imperial-cont clearfix formimperial form-switch" id="imperial-switch">
		<form  method="POST" action="gwc_calculator" class="form-horizontal clearfix" id="calformImp">
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input name="age" required="required" placeholder="<?php echo __('Years','health');?>" min="18" class="c_input" max="95" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Enter your weight:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input max="695" class="c_input" required="required" name="weight" placeholder="<?php echo __('Pounds','health');?>" min="65" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<label class="c_select_label">
					<select name="height" size="1" class="c_select" required="">
						...
						<option value="" selected="selected"><?php echo __('Feet and Inches','health');?></option>
		    ...
		    <div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				...
				<input type="hidden" name="action" value="gwc_calculator" />
			</div>
		</form>
	</div>
	<div class="clear"></div>
	<div class="switch-metric-cont hide clearfix formmetric form-switch" id="metric-switch">
		<form  method="POST" action="gwc_calculator" class="form-horizontal   clearfix" id="calformMetric">
			<div class="calc_quest"></div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Select your gender:','health');?>
			</div>
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input required="required" name="age" placeholder="<?php echo __('Years','health');?>" min="18" max="95" class="c_input" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Enter your weight:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input required="required" name="weight" min="30" placeholder="<?php echo __('kilos','health');?>" max="395" class="c_input" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Select your height:','health');?>
			</div>
