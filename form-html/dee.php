<div class="switch-change-cont">
	...
	<div class="switch-imperial-cont clearfix formimperial form-switch" id="imperial-switch">
		<form  method="POST" action="dee_calculator" class="form-horizontal clearfix" id="calformImp">
			<div class="calc_quest"></div>
				...
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input required="required" max="95" min="18" placeholder="<?php echo __('Years','health');?>" class="c_input" name="age" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Enter your weight:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input max="695" min="65" required="required" class="c_input" placeholder="<?php echo __('Pounds','health');?>" name="weight" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				...
				<input type="hidden" name="action" value="dee_calculator" />
			</div>
		</form>   
	</div>
	<div class="clear"></div>
	<div class="switch-metric-cont hide clearfix formmetric form-switch" id="metric-switch">
		<form  method="POST" action="dee_calculator" class="form-horizontal   clearfix" id="calformMetric">
				<div class="calc_quest"></div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Enter your gender:','health');?>
				</div>
				...
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input max="95" min="18" required="required" class="c_input" placeholder="<?php echo __('Years','health');?>" name="age" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Enter your weight:','health');?>
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
					<input name="weight" placeholder="<?php echo __('kilos','health');?>" class="c_input" min="30" max="395" required="required" type="number">
				</div>
				<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
					<?php echo __('Select your height:','health');?>
				</div>
