<div class="switch-change-cont">
	...
	<div class="switch-imperial-cont clearfix formimperial form-switch" id="imperial-switch">
		<form  method="POST" action="iwc_calculator" class="form-horizontal clearfix" id="calformImp">
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Enter your current weight:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="65" name="weight" required="required" max="695" class="c_input" placeholder="<?php echo __('Pounds','health');?>" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				...
				<input type="hidden" name="action" value="iwc_calculator" />
			</div>
		</form>   
	</div>
	<div class="clear"></div>
	<div class="switch-metric-cont hide clearfix formmetric form-switch" id="metric-switch">
		<form  method="POST" action="iwc_calculator" class="form-horizontal   clearfix" id="calformMetric">
			<div class="calc_quest"></div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="18" name="age" required="required" class="c_input" placeholder="<?php echo __('Years','health');?>" max="95" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Select your height:','health');?>
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<label class="c_select_label">
					<select size="1" name="height" class="c_select" required="">
						...
						<option selected="selected" value=""><?php echo __('meters','health');?></option>
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<input min="30" required="required" name="weight" max="395" placeholder="<?php echo __('kilos','health');?>" class="c_input" type="number">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
			</div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
