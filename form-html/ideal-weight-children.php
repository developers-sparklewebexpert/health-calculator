<div class="switch-change-cont">
	...
	<div class="switch-imperial-cont clearfix formimperial form-switch" id="imperial-switch">
		<form  method="POST" action="iwcc_calculator" class="form-horizontal clearfix" id="calformImp">
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				<label class="c_select_label">
					<select name="height" size="1" class="c_select" required="">
						...
						<option value="14">1' 2"</option>
						<option value="15">1' 3"</option>
						<option value="16">1' 4"</option>
						<option value="17">1' 5"</option>
						<option value="18">1' 6"</option>
						<option value="19">1' 7"</option>
						<option value="20">1' 8"</option>
						<option value="21">1' 9"</option>
						<option value="22">1' 10"</option>
						<option value="23">1' 11"</option>
						...
						<option value="0" selected="selected"><?php echo __('feet and inches','health');?></option>
			...
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_right">
				...
				<input type="hidden" name="action" value="iwcc_calculator" />
			</div>
		</form>   
	</div>
	<div class="clear"></div>
	<div class="switch-metric-cont hide clearfix formmetric form-switch" id="metric-switch">
		<form  method="POST" action="iwcc_calculator" class="form-horizontal   clearfix" id="calformMetric">
			<div class="calc_quest"></div>
			<div class="col-md-12 col-lg-6 col-xs-12 c_form_left">
				<?php echo __('Select your gender:','health');?>
			</div>
